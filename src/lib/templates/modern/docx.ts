...
const SIZE_CONTACT = 22; // half-points (11pt)
const SIZE_SECTION = 24; // half-points (12pt)
...
const BULLET_REFERENCE = "modern-bullets";
...
// ---------------------------------------------------------------------------
// Helper: section heading — blue bold text, no border, no all-caps
// ---------------------------------------------------------------------------
...
function sectionHeading(title: string): Paragraph[] {
  return [
    new Paragraph({
      ...
      children: [
        new TextRun({
          ...font(SIZE_SECTION, { bold: true, color: ACCENT_COLOR }),
          text: title,
        }),
      ],
    }),
